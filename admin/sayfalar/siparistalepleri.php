    ...
    <div class="col-xl-12 col-sm-6 mb-3">
      <div class="table-responsive">
        <table class="table table-bordered">
          <tbody>
            <?php
            $verial1 = $conn -> prepare("SELECT * FROM siparistalepleri order by ID desc");
            $verial1-> execute();
            while ($siparistalepleri = $verial1 -> fetch(PDO::FETCH_ASSOC)){
              if($siparistalepleri["yoneticicevap"]=='Yeni') {
                ...
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
              ...
              if($siparistalepleri["yoneticicevap"]=='Onaylı') {
                echo ' 
                <tr><td><span class="badge badge-warning">'.$siparistalepleri['yoneticicevap'].'</span></td>
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
                <td>'.$siparistalepleri['tarih'].' </td>
                <td><span style="float: right;"><a href="?sayfa=siparisgoruntule&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Yönet</a>&nbsp; <a href="?sayfa=siparistalepleri&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Sil</a></td>
                </tr>';
              }
              if($siparistalepleri["yoneticicevap"]=='Hazır') {
                echo ' 
                <tr><td><span class="badge badge-primary">'.$siparistalepleri['yoneticicevap'].'</span></td>
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
                <td>'.$siparistalepleri['tarih'].' </td>
                <td><span style="float: right;"><a href="?sayfa=siparisgoruntule&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Yönet</a>&nbsp; <a href="?sayfa=siparistalepleri&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Sil</a></td>
                </tr>';
              }
              if($siparistalepleri["yoneticicevap"]=='Kargo') {
                echo ' 
                <tr><td><span class="badge badge-danger">'.$siparistalepleri['yoneticicevap'].'</span></td>
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
                <td>'.$siparistalepleri['tarih'].' </td>
                <td><span style="float: right;"><a href="?sayfa=siparisgoruntule&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Yönet</a>&nbsp; <a href="?sayfa=siparistalepleri&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Sil</a></td>
                </tr>';
              }
              if($siparistalepleri["yoneticicevap"]=='Teslim') {
                echo ' 
                <tr><td><span class="badge badge-dark">'.$siparistalepleri['yoneticicevap'].'</span></td>
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
                <td>'.$siparistalepleri['tarih'].' </td>
                <td><span style="float: right;"><a href="?sayfa=siparisgoruntule&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Yönet</a>&nbsp; <a href="?sayfa=siparistalepleri&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Sil</a></td>
                </tr>';
              }
              if($siparistalepleri["yoneticicevap"]=='İptal') {
                echo ' 
                <tr><td><span class="badge badge-secondary">'.$siparistalepleri['yoneticicevap'].'</span></td>
                <td><b>Ürün:</b> '.$siparistalepleri['urun'].' - <b>Eposta:</b> '.$siparistalepleri['eposta'].' - '.$siparistalepleri['telefon'].'</td>
                <td>'.$siparistalepleri['tarih'].' </td>
                <td><span style="float: right;"><a href="?sayfa=siparisgoruntule&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Yönet</a>&nbsp; <a href="?sayfa=siparistalepleri&id='.$siparistalepleri['id'].'" class="btn-success btn-sm">Hemen Sil</a></td>
                </tr>';
